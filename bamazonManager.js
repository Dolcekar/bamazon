...
var viewProducts = function(){
	...
	connection.query('SELECT * FROM Products', function(err, res){
		...
		for(var i=0; i<res.length; i++){
			table.push(
				[res[i].id, res[i].product_name, res[i].dep_name, res[i].price, res[i].stock_quantity]
			);
		}
...
var addNewProduct = function(){
	...
	prompt.get(newProduct, function(err, res){
		...
		connection.query('INSERT INTO Products (id, product_name, dep_name, price, stock_quantity) VALUES (?, ?, ?, ?, ?);', [addedProduct[0].newIdNum, addedProduct[0].newItemName, addedProduct[0].newItemDepartment, addedProduct[0].newItemprice, addedProduct[0].newstock_quantity], function(err, result){
			...
			console.log('Stock Quantity: ' + addedProduct[0].newstock_quantity);
